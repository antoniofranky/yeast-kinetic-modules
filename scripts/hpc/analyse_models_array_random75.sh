#!/bin/bash
#SBATCH --job-name=r75
#SBATCH --chdir=/work/schaffran1/jobresults/random_75
#SBATCH --output=/work/schaffran1/jobresults/random_75/ka_cocoa_model_%A_%a.out
...
# ============================================================================
MODELS_DIR="/work/schaffran1/toolbox/prpd_models/random_75"  # Directory containing model .xml files
RESULTS_DIR="/work/schaffran1/jobresults/random_75"      # Directory where results will be saved
